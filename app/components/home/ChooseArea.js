  ...
  return (
    <div className="choose-area pt-100 pb-75">
      <div className="container">
        <div className="section-title section-style-two text-center">
        ...
        <div className="row g-lg-4 g-md-3 g-sm-2 justify-content-center">
          <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
            <div
              className="single-choose-card text-center text-md-start"
              data-aos="fade-up"
              data-aos-delay="60"
