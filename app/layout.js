...
export const metadata = {
  ...
  icons: {
    icon: "/images/aroojsolutionfavicon.ico", // Make sure this file exists in public/images/
  },
};
  ...
  return (
    <html lang="en" dir="ltr">
      <head>
        ...
        {/* ✅ Extra fallback for favicon (optional but good) */}
        <link rel="icon" type="image/x-icon" href="/images/aroojsolutionfavicon.ico" />
