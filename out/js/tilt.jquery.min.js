    ...
    return t.fn.tilt = function(i) {
        ...
        h = function() {
            var i = t(this).outerWidth(),
                ...
                n = t(this).offset().top,
                a = (this.mousePositions && this.mousePositions.x ? (this.mousePositions.x - e) / i : 0),  // safeguard for x
                r = (this.mousePositions && this.mousePositions.y ? (this.mousePositions.y - n) / s : 0),  // safeguard for y
                o = (this.settings.maxTilt / 2 - a * this.settings.maxTilt).toFixed(2),
                l = (r * this.settings.maxTilt - this.settings.maxTilt / 2).toFixed(2),
                h = Math.atan2(
                    (this.mousePositions && this.mousePositions.x ? this.mousePositions.x - (e + i / 2) : 0),
                    -(this.mousePositions && this.mousePositions.y ? this.mousePositions.y - (n + s / 2) : 0)
                ) * (180 / Math.PI);
            return {
                tiltX: o,
                tiltY: l,
        ...
        return t.fn.tilt.destroy = function() {
            ...
            }, i), null !== this.settings.axis && (console.warn("Tilt.js: the axis setting has been renamed to disableAxis. See https://gijsroge.github.io/tilt.js/"), this.settings.disableAxis = this.settings.axis), this.init = function() {
